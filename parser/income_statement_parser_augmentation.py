'''
This file parses income statement data from ../data/income_statement/,
combines with historical price data from ../data/historical_price/,
and stores processed data in ../data/processed_data/income_statement_filtered_data_augmentation.txt.
Data augmentation: generates five data points for one year by randomly sampling buying and selling prices
within a month after period ending of income statement.
'''
import os
import datetime
import random
...
if __name__ == '__main__':
  read_directory = '../data/income_statement/'
  write_directory = '../data/processed_data/'
  write_file_name = 'income_statement_filtered_data_augmentation.txt'
