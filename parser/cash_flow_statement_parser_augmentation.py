...
and stores processed data in ../data/processed_data/cash_flow_statement_filtered_data_augmentation.txt.
Data augmentation: generates five data points for one year by randomly sampling buying and selling prices
within a month after period ending of cash flow statement.
'''
import os
import datetime
import random
...
if __name__ == '__main__':
  ...
  write_file_name = 'cash_flow_statement_filtered_data_augmentation.txt'
