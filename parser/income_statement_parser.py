...
and stores processed data in ../data/processed_data/income_statement_filtered_data.txt.
'''
import os
import datetime
...
if __name__ == '__main__':
  ...
  for file in read_files:
    ...
    with open(file_path, 'r') as f:
      ...
      with open(write_directory + 'income_statement_filtered_data.txt', 'a') as wf:
        if is_first_file:
